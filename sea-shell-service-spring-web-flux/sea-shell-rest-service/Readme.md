...
2.  mutable solution with loose running subscribers
3.  wrapping a blocking call
4.  awaiting for the loose subscribers
5.  wrapping futures and fork-joins
6.  one by one alternative
7.  mutable solution with coordinated publishers
8.  immutable solution with coordinated publishers
